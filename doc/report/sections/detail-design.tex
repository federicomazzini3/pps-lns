...
\subsubsection{Door}
Un dettaglio importante di una stanza sono le porte. Una porta, per il character, rappresenta il collegamento tra una stanza e un altra, ma a livello di modello sono semplicemente l'associazione di un lato con uno stato. 

Una porta è quindi un elemento statico di una stanza e non un link. E' il Dungeon a gestire il collegamento tra le varie stanze in base alla loro posizione occupata all'interno della griglia precedentemente illustrata. 
